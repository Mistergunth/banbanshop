...
import 'package:banbanshop/screens/profile.dart'; // ตรวจสอบว่าไฟล์นี้มี SellerProfile และ extension copyWith
...
class _SellerAccountScreenState extends State<SellerAccountScreen> {
  ...
  final Cloudinary cloudinary = Cloudinary.full(
    ...
    apiKey: '157343641351425', // <-- ไม่จำเป็นสำหรับ Unsigned Uploads แต่ใส่ไว้เผื่อใช้ Signed Uploads
    apiSecret: 'uXRJ6lo7O24Qqdi_kqANJisGZgU', // <-- ไม่จำเป็นสำหรับ Unsigned Uploads แต่ใส่ไว้เผื่อใช้ Signed Uploads
  );
    ...
    try {
      ...
      if (response.isSuccessful) {
        ...
        if (downloadUrl != null) {
          ...
          if (!mounted) return;
          setState(() {
            // เรียกใช้ copyWith จาก extension ที่อยู่ใน profile.dart
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                GestureDetector( 
                  onTap: _pickAndUploadImage, // เรียกใช้ฟังก์ชันอัปโหลดรูปภาพจริง
                  child: CircleAvatar(
                    radius: 50,
...
// **ย้าย extension SellerProfileCopyWith นี้ไปไว้ใน profile.dart เท่านั้น**
